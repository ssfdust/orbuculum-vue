...
<template>
  <el-space style="width: 100%" direction="vertical" :fill="fill">
    ...
    <el-row>
      <el-table :data="connections" :default-sort="{ prop: 'name', order: 'ascending' }" :columns="columns">
        <el-table-column prop="name" label="网卡名" width="180"/>
        <el-table-column prop="interface" label="网卡" width="180"/>
